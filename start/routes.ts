...
router
  .group(() => {
    ...
    router.get('/deluser/:id', [UsersController, 'destroy']).as('deluser')
    //CHAIR
    ...
    router.get('delchair/:id', [ChairController, 'destroy']).as('delchair')
    //QR
    ...
    router.get('/showproduct/:id', [ProductController, 'show']).as('showproduct')
    ...
    router.get('/delproduct/:id', [ProductController, 'destroy']).as('delproduct')
    //CATEGORY
